...
update `Party` set `color` = "00adef" where `party_id` = 35;
update `Party` set `color` = "8ec83e" where `party_id` = 2;
update `Party` set `color` = "488e41" where `party_id` = 23;
update `Party` set `color` = "92278f" where `party_id` = 44;
update `Party` set `color` = "522c7f" where `party_id` = 43;
update `Party` set `color` = "f6a71d" where `party_id` = 45;
update `Party` set `color` = "199094" where `party_id` = 47;
update `Party` set `color` = "EE4D9B" where `party_id` = 46;
