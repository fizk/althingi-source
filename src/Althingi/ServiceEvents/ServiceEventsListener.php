    ...
    ElasticSearchAwareInterface
{
    ...
    {
        $this->listeners[] = $events->attach('add', new Add($this->client));
        $this->listeners[] = $events->attach('update', new Update($this->client));
        $this->listeners[] = $events->attach('delete', new Delete($this->client));
    }
